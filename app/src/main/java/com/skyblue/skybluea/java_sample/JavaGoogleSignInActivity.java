...
import com.skyblue.skybluea.databinding.ActivityJavaGoogleSignInBinding;

public class JavaGoogleSignInActivity extends AppCompatActivity {
    private ActivityJavaGoogleSignInBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityJavaGoogleSignInBinding.inflate(getLayoutInflater());
        ...
        binding.cvGoogleSignIn.setOnClickListener(view -> signIn());
    }
    /**
