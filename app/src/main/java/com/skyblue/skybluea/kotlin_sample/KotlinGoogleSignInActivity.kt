...
class KotlinGoogleSignInActivity : AppCompatActivity() {
    private lateinit var binding: ActivityKotlinGoogleSignInBinding
    private var context: Context = this@KotlinGoogleSignInActivity
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityKotlinGoogleSignInBinding.inflate(layoutInflater)
        ...
        binding.sibGoogleSignIn.setSize(SignInButton.SIZE_STANDARD)

        binding.sibGoogleSignIn.setOnClickListener(){
            signIn();
        }
